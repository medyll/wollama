...
const setupPiper = async () => {
    ...
    // Download Models
    const voices = [
        { lang: 'en_US', name: 'en_US-lessac-medium', url: 'https://huggingface.co/rhasspy/piper-voices/resolve/v1.0.0/en/en_US/lessac/medium/en_US-lessac-medium.onnx' },
        { lang: 'fr_FR', name: 'fr_FR-siwis-medium', url: 'https://huggingface.co/rhasspy/piper-voices/resolve/v1.0.0/fr/fr_FR/siwis/medium/fr_FR-siwis-medium.onnx' },
        { lang: 'de_DE', name: 'de_DE-thorsten-medium', url: 'https://huggingface.co/rhasspy/piper-voices/resolve/v1.0.0/de/de_DE/thorsten/medium/de_DE-thorsten-medium.onnx' },
        { lang: 'es_ES', name: 'es_ES-sharvard-medium', url: 'https://huggingface.co/rhasspy/piper-voices/resolve/v1.0.0/es/es_ES/sharvard/medium/es_ES-sharvard-medium.onnx' },
        { lang: 'it_IT', name: 'it_IT-riccardo-x_low', url: 'https://huggingface.co/rhasspy/piper-voices/resolve/v1.0.0/it/it_IT/riccardo/x_low/it_IT-riccardo-x_low.onnx' }
    ];
