...
export const config = {
    ...
    stt: {
        ...
        binaryPath: process.env.STT_BINARY_PATH || path.resolve(process.cwd(), 'bin', 'whisper', process.platform === 'win32' ? 'main.exe' : 'main'),
    ...
    tts: {
        ...
        binaryPath: process.env.TTS_BINARY_PATH || path.resolve(process.cwd(), 'bin', 'piper', process.platform === 'win32' ? 'piper.exe' : 'piper'),
