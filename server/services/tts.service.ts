...
export const TtsService = {
    async speak(text: string, voiceId: string = 'alloy', voiceTone: 'neutral' | 'fast' | 'slow' | 'deep' | 'high' = 'neutral'): Promise<ArrayBuffer | null> {
    ...
    async speakLocal(text: string, voiceId?: string, voiceTone: 'neutral' | 'fast' | 'slow' | 'deep' | 'high' = 'neutral'): Promise<ArrayBuffer | null> {
    ...
    async speakLocalWithModel(text: string, binaryPath: string, modelPath: string, voiceTone: 'neutral' | 'fast' | 'slow' | 'deep' | 'high' = 'neutral'): Promise<ArrayBuffer | null> {
