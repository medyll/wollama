...
<div class="flex h-screen overflow-hidden bg-base-100">
    ...
    <div class="flex-1 flex flex-col h-full relative">
        <!-- Top Navigation Bar -->
        <header class="navbar bg-base-100 border-b border-base-content/10 min-h-16 z-10">
            <div class="flex-none">
            ...
            <div class="flex-none flex items-center gap-2">
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" class={`h-5 w-5 ${connectionState.isConnected ? 'text-success' : 'text-error'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
